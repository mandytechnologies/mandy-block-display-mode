...
class Plugin_Updater {
	 ...
	 * 'https://bitbucket.org/teammandy/[name]/raw/HEAD/package.json'.
	 *
	 * @var string
	 */
	public $info_url;
	...
	/**
	 * The bitbucket zip extracts to a folder that has teammandy at the
	...
	function upgrader_post_install($response, $hook_extra, $result) {
		...
		$pattern = '/teammandy-' . $slug . '-[0-9a-f]+\/?$/i';
