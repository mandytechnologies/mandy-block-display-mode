...
class Mbdm_Plugin_Template {

	/**
	 * The single instance of Mbdm_Plugin_Template.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	/**
	 * Main Mbdm_Plugin_Template Instance
	 *
	 * Ensures only one instance of Mbdm_Plugin_Template is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Mbdm_Plugin_Template()
	 * @return Main Mbdm_Plugin_Template instance
	 */
